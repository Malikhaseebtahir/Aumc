...
namespace Aumc.Migrations
{
    ...
    [Migration("20200322122932_AddingUniversityNewsTable")]
    partial class AddingUniversityNewsTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Aumc.Core.Models.GroupNewsLetter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Aumc.Core.Models.PostComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Aumc.Core.Models.StudentGroupComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("StudentGroupComments");
                });
            ...
            modelBuilder.Entity("Aumc.Core.Models.StudentGroupPostComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("StudentGroupPostComments");
                });

            modelBuilder.Entity("Aumc.Core.Models.UniversityNews", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Aumc.Core.Models.GroupNewsLetter", b =>
                {
                    b.HasOne("Aumc.Core.Models.Group", "StudentGroup")
                        .WithMany()
                        .HasForeignKey("GroupId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Aumc.Core.Models.StudentGroupPostComment", b =>
                {
                    b.HasOne("Aumc.Core.Models.StudentGroupPost", "Post")
                        .WithMany("StudentGroupPostComments")
                        .HasForeignKey("PostId")
                        .OnDelete(DeleteBehavior.Restrict);
