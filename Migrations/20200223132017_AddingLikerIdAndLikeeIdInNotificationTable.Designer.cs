...
namespace Aumc.Migrations
{
    ...
    [Migration("20200223132017_AddingLikerIdAndLikeeIdInNotificationTable")]
    partial class AddingLikerIdAndLikeeIdInNotificationTable
    {
            ...
            modelBuilder.Entity("Aumc.Core.Models.Notification", b =>
                {
                    ...
                    b.HasOne("Aumc.Core.Models.User", "Like")
                        .WithMany()
